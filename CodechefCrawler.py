            ...
            if tablebox_section !=None:
                ...
                for current_row in rows:
                         if current_row.img != None and current_row.img["src"] == "/misc/tick-icon.gif":
                            ...
                            print(solution_url)
                            solution_result = requests.get(solution_url,headers={'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.95 Safari/537.36'})
                            ...
                            solution_plain_text_request = requests.get(solution_plain_text_url,headers={'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.95 Safari/537.36'})
